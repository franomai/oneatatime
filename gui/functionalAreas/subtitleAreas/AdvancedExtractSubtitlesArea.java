...
/**
 * This class represents the advanced extract subtitles pane. It contains the create method for painting this pane,
 * some behaviors associated with components in this pane, and methods for accessing fields in this pane from
 * basic panes, more specifically the basic extract subtitles pane.
 * @author fsta657
 *
 */
@SuppressWarnings("serial")
public class AdvancedExtractSubtitlesArea extends AbstractFunctionalArea implements
		ActionListener {
	...
	public AdvancedExtractSubtitlesArea() {
		super();
	}
	...
	protected JPanel createAreaSpecific() {
		...
		// Set up area title
		JLabel areaTitle = new JLabel("Advanced Extract Subtitles");
	...
	/**
	 * Get the output name provided by the user for the extract operation.
	...
	/**
	 * Get the output location provided by the user for the extract operation.
