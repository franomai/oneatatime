...
/**
 * This class represents the advanced replace pane. It contains the create method for painting this pane,
 * some behaviors associated with components in this pane, and methods for accessing fields in this pane from
 * basic panes, more specifically the basic replace pane.
 * @author fsta657
 *
 */
@SuppressWarnings("serial")
public class AdvancedReplaceAudioArea extends AbstractFunctionalArea implements
		ActionListener {
	...
	public AdvancedReplaceAudioArea() {
		super();
	}
	...
	protected JPanel createAreaSpecific() {
		...
		// Set up area title
		JLabel areaTitle = new JLabel("Advanced Replace Audio");
	...
	/**
	 * Get the output name provided by the user for the replace operation.
	...
	/**
	 * Get the output location provided by the user for the replace operation.
